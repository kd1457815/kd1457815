# Hi there 👋 I'm Eric
Welcome to my GitHub profile! / 歡迎來到我的 GitHub 首頁！ / 私のGitHubへようこそ！
---
## 🚀 Latest Project / 最新上線作品 / 最新の公開プロジェクト
### 🌐 Live2D AI Chat
**[👉 Click to Play / 立刻體驗 / デモを体験する](https://in-time5298.com)**
...
*(Note: The source code repository is set to Private to protect backend API keys and ensure user privacy.)*
🇹🇼 **繁體中文**  
這是我獨立開發的「支援多語系、即時語音互動與 AI 聊天的 Live2D 網站」。  
*(註：為了嚴格保護後端 API 金鑰與使用者隱私，該專案的原始碼已設定為 Private 不對外公開。)*
🇯🇵 **日本語**  
